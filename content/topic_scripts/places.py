...
},
{
  ...
  "content": 
    ...
    "- Each topic must represent an easy to guess for an average joe, top of mind, well-known specific landmark, city, country, or place (e.g., 'Paris', 'Great Wall of China').\n"
