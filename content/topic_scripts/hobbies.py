...
},
{
  ...
  "content": 
    ...
    "- A topic should be an, easy to guess for an average joe, common, everyday hobby or pastime that people enjoy regularly (e.g., knitting).\n"
...
with open("./data/hobbies.json", "w") as f:
