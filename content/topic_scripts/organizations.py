...
},
{
  ...
  "content": 
    ...
    "- A topic should be an easy to guess for an average joe, top of mind, well-known international major Organization or Institution (e.g., 'United Nations', 'NASA).\n"
    ...
    "- Topics must include at least 2 **spelling variants, synonyms, abbreviations or simplified forms**. This is a key rule. Here are a couple examples: \n"
    "  - 'United Nations', 'UN'\n"
