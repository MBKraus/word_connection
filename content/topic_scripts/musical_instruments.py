...
},
{
  ...
  "content": 
    ...
    "- A topic should be an easy to guess for an average joe, top of mind, well-known musical instrument (e.g., Piano, Guitar).\n"
    ...
    "- Generate 35 topics with 4 descriptive entries each, ensuring no overlap between topics or their descriptive entries.\n"
    }
    ],
...
with open("./data/musical_instrument.json", "w") as f:
