...
},
{
  ...
  "content": 
    ...
    "- a topic should be easy to guess for the average joe, not complex, very simple, and should be a well-known subject related to natural phenomena, ecosystems, and geographic wonders (e.g., deserts, oceans).\n"
...
with open("./data/nature.json", "w") as f:
