...
},
{
  ...
  "content": 
    ...
    "- **Topic:** ['Mona Lisa', 'The Mona Lisa', 'Portrait of Lisa Gherardini']\n"
    "  **Entries:** ['Leonardo da Vinci', 'Louvre Museum', 'Sfumato technique', 'Renaissance Art']\n"
...
with open("./data/art.json", "w") as f:
