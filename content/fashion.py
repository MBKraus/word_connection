...
},
{
  ...
  "content": 
    ...
    "- a topic should be easy to guess for the average joe, not complex, very simple, and should be a well-known subject related to clothing, trends, designers, and iconic styles through history.\n"
...
with open("./data/fashion.json", "w") as f:
