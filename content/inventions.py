...
},
{
  ...
  "content": 
    ...
    "- A topic should be an easy to guess for an average joe, top of mind, non-complex, simple invention (e.g., 'Light Bulb', 'Radio').\n"
...
with open("./data/inventions.json", "w") as f:
